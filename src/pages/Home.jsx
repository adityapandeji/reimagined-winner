...
import Banner from "../assets/Images/AI.mp4";
// Component Imports
  ...
  return (
    <div>
      ...
      <div className="relative mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8 text-white">
        ...
        {/* CTA Buttons */}
        <div className="mt-8 flex flex-col gap-4 md:flex-row md:gap-7">
        ...
        <div className="mx-4 my-7 shadow-[10px_-5px_50px_-5px] shadow-blue-200">
          <video
            className="shadow-[20px_20px_rgba(255,255,255)] w-full h-auto"
            muted
            loop
            autoPlay
          >
        ...
        <div>
          <CodeBlocks
            ...
            codeblock={`public class Welcome {
    public static void main(String[] args) {
        System.out.println("Welcome to Academix");
    }
}
`}
...
`}
      ...
      <div className="bg-pure-greys-5 text-richblack-700">
        <div className="homepage_bg h-[240px] md:h-[320px]">
          {/* Explore Full Catalog Section */}
          <div className="mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8">
            <div className="lg:h-[150px]"></div>
            <div className="flex flex-col gap-4 md:flex-row md:gap-7 text-white lg:mt-8">
              <CTAButton active={true} linkto={"/signup"}>
        ...
        <div className="mx-auto flex w-11/12 max-w-maxContent flex-col items-center justify-between gap-8">
          ...
          <div className="mb-10 mt-[-50px] md:mt-[-100px] flex flex-col justify-between gap-7 lg:mt-20 lg:flex-row lg:gap-0">
